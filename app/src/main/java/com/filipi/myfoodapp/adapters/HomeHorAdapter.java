package com.filipi.myfoodapp.adapters;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if(check) {
            ...
            holder.cardView.setOnClickListener(new View.OnClickListener() {
                @SuppressLint("NotifyDataSetChanged")     /////////////isso aq
                @Override
                public void onClick(View view) {
                    ...
                    if (position == 0){
                        ...
                        homeVerModels.add(new HomeVerModel(R.drawable.burger1, "Burguer 1","10:00 - 23:00", "4.9", "Min - $35"));
                        homeVerModels.add(new HomeVerModel(R.drawable.burger2, "Burguer 2","10:00 - 23:00", "4.9", "Min - $35"));
                        homeVerModels.add(new HomeVerModel(R.drawable.burger4, "Burguer 3","10:00 - 23:00", "4.9", "Min - $35"));
